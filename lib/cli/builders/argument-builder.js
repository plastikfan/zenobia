...
function normaliseArguments (commandArguments) {
  let normalisedArguments = R.omit([defaultSpec.labels.descendants], commandArguments);
  let children = commandArguments[defaultSpec.labels.descendants];
  ...
  normalisedArguments[defaultSpec.labels.descendants] = normalisedChildren;
